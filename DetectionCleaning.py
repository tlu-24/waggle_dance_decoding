...
prefix = 'test'
waggle_df = pd.read_csv('WaggleDetections154-test.csv')#WaggleDetections-test.pkl')
...
df.to_pickle('WaggleDetections154-test-cleaned.pkl')
df.to_csv('WaggleDetections154-test-cleaned.csv')
#df.to_pickle('WaggleDetections-{}-Cleaned.pkl'.format(prefix))
#df.to_csv('WaggleDetections-{}-Cleaned.csv'.format(prefix))